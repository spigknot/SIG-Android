...
static void ggml_vk_get_physical_device_features_2(VkPhysicalDevice physical_device, VkPhysicalDeviceFeatures2 * features) {
    ...
    if (fn == nullptr) {
        fn = reinterpret_cast<PFN_vkGetPhysicalDeviceFeatures2>(
            vkGetInstanceProcAddr(vk_instance.instance, "vkGetPhysicalDeviceFeatures2KHR"));
    }
    if (fn == nullptr) {
        throw std::runtime_error("Vulkan vkGetPhysicalDeviceFeatures2 unavailable");
    }
    fn(physical_device, features);
}
...
static vk_device ggml_vk_get_device(size_t idx) {
    ...
    if (vk_instance.devices[idx] == nullptr) {
        ...
        ggml_vk_get_physical_device_features_2(device->physical_device, &device_features2);
...
static void ggml_vk_print_gpu_info(size_t idx) {
    ...
    ggml_vk_get_physical_device_features_2(physical_device, &device_features2);
...
static bool ggml_vk_device_is_supported(const vk::PhysicalDevice & vkdev) {
    ...
    ggml_vk_get_physical_device_features_2(vkdev, &device_features2);
