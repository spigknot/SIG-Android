...
extern "C" {
    ...
    enum ggml_type {
        ...
        GGML_TYPE_Q1_0    = 41,
        // ⚠️ VALORES TROCADOS de propósito (app SIG, fork privado): o GGUF oficial
        // Hy-MT2-1.8B-1.25Bit.gguf foi gravado com STQ1_0 = 42 (enum do PR #22836 em
        // mai/2026, antes do rebase de ago que o tornou 43). Para o arquivo publicado
        // carregar sem reetiquetar, mantemos STQ1_0 = 42 e mandamos Q2_0 para 43.
        // Nenhum modelo Q2_0 é usado neste app. Reverter ao sincronizar o fork.
        GGML_TYPE_Q2_0    = 43,
        GGML_TYPE_STQ1_0  = 42,
        GGML_TYPE_COUNT   = 44,
    };
