...
| Versão gerada de madrugada com a data do DIA ANTERIOR (ex.: `20260924_004` publicada 01:29 local do dia 25) | a regra usa a data LOCAL (`America/Sao_Paulo`), mas o carimbo do GitHub Releases é UTC — de madrugada os dois divergem (04:29 UTC = 01:29 local) | conferir `date +%F` (local) antes do bump: se o dia local mudou, reiniciar em `_001` com a data de HOJE — nunca continuar a numeração do dia anterior |
